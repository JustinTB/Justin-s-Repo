...
public class FloorBuilder {
    ...
    public FloorBuilder(WorldManager worldManager, ShadowMapRenderBuffer shadowMapBuffer){
     ...
     public void createFloor() {
        ...
        floorRenderComponent = worldManager.getRenderManager().createRenderComponent(orthoQuad);
        floorEntity.addComponent(RenderComponent.class, floorRenderComponent);
