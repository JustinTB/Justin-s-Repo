 ...
 * @author justin
 */
public class PauseMenuController extends AbstractAppState implements ScreenController {

    private Nifty nifty;
    private Screen screen;
    private SimpleApplication app;
    private WalkingAvatarState game;
    ...
    public void initialize(AppStateManager stateManager, Application app, WalkingAvatarState game){
