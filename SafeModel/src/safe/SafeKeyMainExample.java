 ...
 * @author justin
 */
public class SafeKeyMainExample {

    
    public static void main(String[] args) {
          
        //Declare new safe, new combo lock, new door
        Safe mySafe = new Safe();
        KeyLock myLock = new KeyLock("(o)^^-^>");
        ...
        //Declaration of choic and itemName bariables
        int choice;
        String itemName;
...
}//End of SafeKeyMainExample class
