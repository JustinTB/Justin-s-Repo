...
public class ShapeCellRenderer extends BasicRenderer {
    ...
    public void updateShape() {
        ...
        //final String textureURI = ((ShapeCell)cell).getTextureURI();
    ...
    public void updateTextureURI(){
        ...
        if (textureURI != null) {
            ...
            final TextureState ts = (TextureState) rm.createRendererState(StateType.Texture);
            Texture t = null;
            try {
