...
//    }
    ...
    private static MyMouseSelectionProcessor mouseSelector;
    ...
    public void createCameraEntity(WorldManager wm) {
        ...
        mouseSelector = new MyMouseSelectionProcessor(selectionListener, wm, cameraEntity, cameraEntity, width, height, eventProcessor);
